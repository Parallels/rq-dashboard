...
RQ Dashboard does not contain any built-in authentication mechanism. If
required it can be added e.g. with:

    @dashboard.before_request
    def authentication_hook():
        ... some test which if fails then results in abort(401)
